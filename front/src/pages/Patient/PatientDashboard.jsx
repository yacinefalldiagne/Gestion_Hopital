    ...
    return (
        <div className="min-h-screen bg-gray-100 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="md:col-span-1">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                        ...
                        <div className="space-y-4">
                            {dashboardData.doctors.length > 0 ? (
                                dashboardData.doctors.map((doctor) => (
                                    <div key={doctor.id} className="flex items-center justify-between">
                                        ...
                                        <span className={`${doctor.color} text-sm font-medium px-2 py-1 rounded`}>
                            ...
                            <Link
                                to="/patient/doctors"
                                className="block w-full mt-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300 text-center"
                            >
                                Plus
                            </Link>
                        </div>
                ...
                {/* Middle Section - Calendar and Appointments */}
